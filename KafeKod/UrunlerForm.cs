...
namespace KafeKod
{
    public partial class UrunlerForm : Form
    {
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            dgvUrunler.DataSource = dgvUrunler.DataSource = new BindingSource(db.Urunler.OrderBy(x => x.UrunAd).ToList(), null);
        }
        ...
        private void dgvUrunler_UserDeletingRow(object sender, DataGridViewRowCancelEventArgs e)
        {
            ...
            {
                MessageBox.Show("Geçmiş siparişle ilişkili olduğu için silinemez");
                e.Cancel = true;
                return;
            }
